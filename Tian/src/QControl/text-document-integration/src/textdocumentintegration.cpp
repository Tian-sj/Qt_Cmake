#include <text-document-integration/textdocumentintegration.h>

#include "ui_textdocumentintegration.h"

TextDocumentIntegration::TextDocumentIntegration(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::TextDocumentIntegration)
{
    ui->setupUi(this);
...
TextDocumentIntegration::~TextDocumentIntegration()
{
    delete ui;
}

void TextDocumentIntegration::setupPlot()
{
...
void TextDocumentIntegration::on_actionInsert_Plot_clicked()
{
...
void TextDocumentIntegration::on_actionSave_Document_clicked()
{
